...
{js file="http://shared.life-link.org/jquery.plugins/_preview/jquery.codaslider-1.0/coda-slider.js" absolute=true merge=true where="head"}
{css file="/css/source/codaslider.css"}
