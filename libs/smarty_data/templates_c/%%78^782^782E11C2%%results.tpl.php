<?php /* Smarty version 2.6.16, created on 2011-06-14 23:55:58
         compiled from pages/live/appendix/results.tpl */ ?>
...
<?php if ($this->_tpl_vars['post']['attachments']): ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => ($this->_tpl_vars['tpl']['current'])."appendix/item.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
