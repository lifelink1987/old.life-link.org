<?php /* Smarty version 2.6.16, created on 2011-06-14 23:15:26
         compiled from pages/join/default.tpl */ ?>
<div id="llpagetitle">Want to Join in?</div>
<?php if ($this->_tpl_vars['context']): ?>
	<div id="llpagesubtitle">This registration is part of the <?php echo $this->_tpl_vars['context']['title']; ?>
 registration!</div>
<?php else: ?>
	<div id="llpagesubtitle">Is your school already registered and you just want to Report a New Action? <a href="<?php echo $this->_tpl_vars['tpl']['links']['report']; ?>
">Click Here!</a></div>
<?php endif; ?>
