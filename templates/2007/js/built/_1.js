...
YAHOO.namespace('ll.wait');YAHOO.ll.event.pageLoad.subscribe(function(type,args){YAHOO.ll.wait.widget=new YAHOO.widget.Panel('wait',{width:'350px',fixedcenter:true,underlay:'shadow',draggable:false,close:false,modal:true,zIndex:1000});YAHOO.ll.wait.widget.setBody('<img alt="" src="/templates/2007/images/loading.gif">');YAHOO.ll.wait.widget.showMaskEvent.subscribe(fixMask,YAHOO.ll.wait.widget,true);YAHOO.ll.wait.widget.hideEvent.subscribe(fixHide,YAHOO.ll.wait.widget,true);});
...
var fileLoadingImage="/templates/2007/images/loading.gif";var fileBottomNavCloseImage="/templates/2007/images/lightbox/closelabel.gif";var resizeSpeed=6;var borderSize=10;var imageArray=new Array;var activeImage;if(resizeSpeed>10){resizeSpeed=10;}
