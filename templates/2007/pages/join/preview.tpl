...
<div class="lltextsmall">
	...
	<{assign var='nolinks' value=true}>
	<{assign var='notoggler' value=true}>
	<{include file="pages/member.tpl"}>
...
<div class="hr"></div>
<span class="llclear h30"></span>
<form method="post" action="<{$tpl.links.join}>" id="form-report-edit" class="major lltextsmall">
